...
import installStyle from '@element-pro/test-utils/style-plugin'
import Checkbox from '@element-pro/components/checkbox/src/checkbox.vue'
import CheckboxGroup from '@element-pro/components/checkbox/src/checkbox-group.vue'
