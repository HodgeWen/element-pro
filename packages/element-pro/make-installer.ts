import { setConfig } from '@element-pro/utils/config'
import { localeContextKey, localeProviderMaker } from '@element-pro/hooks'
import { version } from './version'

import type { App, Plugin } from 'vue'
import type { ComponentSize } from '@element-pro/utils/types'
import type { InstallOptions } from '@element-pro/utils/config'
