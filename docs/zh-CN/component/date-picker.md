...
| format                | 显示在输入框中的格式                                                                                             | string                                           | 请查看 [date formats](/zh-CN/component/date-picker#date-formats)           | YYYY-MM-DD  |
...
| value-format          | 可选，绑定值的格式。 不指定则绑定值为 Date 对象                                                                  | string                                           | 请查阅 [date formats](/zh-CN/component/date-picker#date-formats)           | —           |
| name                  | 原生属性                                                                                                         | string                                           | —                                                                          | —           |
